...
usage() {
    ...
    echo ""
    echo "Commands:"
    echo "  deploy-test-environment <base token> <loan router v2>"
    echo ""
    ...
    echo ""
    echo "  upgrade-usdai"
    echo "  upgrade-staked-usdai <loan router v2> <admin fee recipient> <base admin fee rate> <loan router admin fee rate>"
    echo "  upgrade-otoken <token>"
    echo "  upgrade-base-yield-escrow"
    echo "  upgrade-ousdai-utility <admin> <lz endpoint> <base token o adapter>"
    echo ""
    ...
    echo "  deploy-ousdai-utility <deployer> <admin> <lz endpoint> <base token o adapter>"
